...
# The vault bucket — Object Lock must be enabled at creation, cannot be retrofitted
...
# Default retention applied to every object uploaded to this bucket
...
# Deny bucket deletion from everyone except account root
